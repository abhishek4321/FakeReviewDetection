...
if __name__ == '__main__':
    ...
    nyc_zip_code_start= zip_code = 10014
    nyc_zip_code_end = 10016
    ...
    while zip_code <= nyc_zip_code_end:
        try :
            ...
            print "saving"
            with open('finalgen.json','a') as f1:
